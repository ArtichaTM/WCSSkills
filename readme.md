...
* __WCSSkills__ - Главная папка
    ...
    * __../events/__ - Папка, содержащий код для системы событий
    * __../JSONs/__ - Здесь лежат статичные JSON
    * __../menus/__ - Ради меню
    * __../other_functions/__ - Разные важные функции / файлы
    * __../python/__ - Чистый код на python, не связанный с Source.Python
    * __../skills/__ - Здесь лежат классы всех способностей
...
* _Текстовый_ - Просто написать словами, как способность работает
...
Константы _owner_ / _lvl_ / _settings_ уже созданы, и писать их заново не нужно.

После строки `super().__init__(lvl, userid, settings)` следует ваш код.
...
* **self.settings** — настройки, которые можно настроить в Мои навыки -> {название навыка} -> параметры.
В коде они принимают форму словаря в виде _{"Название": "значение (может быть не string)"}_
____
...
* **Способности**
  ...
  - [X] Висячие в воздухе мины ~~(основано на технике выше)~~
  - [X] Смена режима (вкл. режим призрака) при взятии ножа
